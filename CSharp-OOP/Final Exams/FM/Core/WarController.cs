...
namespace WarCroft.Core
{
	public class WarController
	{
			...
			public string GetStats()
			{
				...
				{
					result += $"{character.Name} - HP: {character.Health}/{character.Health}," +
						$" AP: {character.Armor}/{character.Armor}, Status: {character.IsAlive}\r\n";
			...
			public string Attack(string[] args)
			{
				...
				var character = this.characterParty.FirstOrDefault(x => x.Name == attackerName);
				...
				if (receiver.IsAlive)
				{
					return $"{attackerName} attacks {receiverName} for {warrior.AbilityPoints} hit points! " +
						$"{receiverName} has {receiver.Health}/{receiver.Health} " +
						$"HP and {receiver.Armor}/{receiver.Armor} AP left!";
